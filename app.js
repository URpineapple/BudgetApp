...
var budgetController = (function () {
    ...
    return {
        addItem: function (type, des, val) {
            ...
            //Create new items based on the type 'exp' / 'inc'
            if (type === 'exp') {
...
var UIController = (function () {
    ...
    var formatNumber = function (num, type) {
        ...
        inc = numSplit[0];
        if (inc.length > 3) {
            inc = inc.substr(0, inc.length - 3) + ", " + inc.substr(inc.length - 3, inc.length);
        }
    ...
    return {
        ...
        addListItem: function (obj, type) {
            ...
            //Replace the placeholder text with some actual text data
